...
Tests the user profile endpoints including:
...
During testing, the following differences were identified between the Swagger documentation and the actual API behaviour:

| Endpoint | Swagger Documentation | Actual API Behaviour |
|---|---|---|
...
These discrepancies have been documented, and the tests are written to match the actual API behaviour to ensure they pass consistently.
